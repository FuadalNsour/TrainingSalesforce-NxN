  ...
  return (
    <div className="bg-black">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-display font-bold mb-8">Learning Path</h2>
      ...
      {/* Course Info */}
      <section className="max-w-7xl mx-auto px-6 py-16 border-t border-gray-700 mt-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-secondary">Hours of training</p>
          </div>
          <div>
            <p className="text-4xl font-display font-bold text-accent">∞</p>
            <p className="text-secondary">Learn at your pace</p>
          </div>
        </div>
      </section>
    </div>
